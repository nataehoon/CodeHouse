...
#적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\skxog\\Desktop\\PythonWorkSpace\\pygame_basic\\enemy.png")
...
enemy_y_pos = screen_hight / 2 - (enemy_height / 2) #화면 세로 크기 가장 아래에 해당하는 곳에 위치
